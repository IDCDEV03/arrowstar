...
<div class="container-fluid">
   <div class="row">
      <div class="col-sm-12">
         ...
         <div class="card">    
          <form class="form theme-form" action="<?php echo e(route('admin.update_travel_os')); ?>" method="POST" >
              <?php echo csrf_field(); ?>
                    ...
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <select class="form-select input-air-primary" name="province1" id="province1">
                            <option value="0" selected>-<?php echo e($list->ct_nameTHA); ?></option>  
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control input-air-primary" name="travel_city" id="travel_city" type="text" value="<?php echo e($list->city_name); ?>">
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <textarea name="travel_detail" id="travel_detail" class="form-control" rows="5"><?php echo e($list->travel_detail); ?></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <textarea name="travel_remark" id="travel_remark" class="form-control" rows="5"><?php echo e($list->travel_remark); ?></textarea>
                      </div>
                    </div>
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/admin/edit_travel_os.blade.php ENDPATH**/ ?>