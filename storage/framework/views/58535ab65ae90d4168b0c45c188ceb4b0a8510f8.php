            ...
            <div class="container py-5">
                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <!--start_form-->
                        <form action="<?php echo e(route('save_rental')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="start_province" name="start_province">
                                            ...
                                            <?php $__currentLoopData = $list_province; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->name_th); ?>"><?php echo e($data->name_th); ?></option>
...
<?php echo $__env->make('index.index_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/index/rent_car.blade.php ENDPATH**/ ?>