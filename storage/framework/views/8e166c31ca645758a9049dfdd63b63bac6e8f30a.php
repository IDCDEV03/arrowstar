            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    ?>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="<?php echo e(route('admin.new_package', ['id' => $pos_id])); ?>" class="btn btn-outline-info" ><i class="fa fa-plus-square-o"></i> เพิ่มโปรแกรมใหม่</a>
                ...
                <tbody>
                    <?php $__currentLoopData = $list_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(route('admin.preview_package', ['id' => $item->package_id])); ?>"><?php echo e($item->package_name); ?></a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\Documents\GitHub\arrowstar\resources\views/admin/all_program.blade.php ENDPATH**/ ?>