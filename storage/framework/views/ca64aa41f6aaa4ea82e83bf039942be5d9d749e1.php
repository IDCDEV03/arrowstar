                   ...
                   <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <textarea name="travel_detail" id="summernote"><?php echo e($list->travel_detail); ?></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <textarea name="travel_remark" id="summernote2"><?php echo e($list->travel_remark); ?></textarea>
                      </div>
                    </div>
                  </div>
