                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-control-static">
                                                <span class="txt-info"><?php echo e($row->price_total); ?></span> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-control-static">
                                               <span class="txt-danger"><?php echo e($row->price_notin); ?></span> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/admin/preview_package_os.blade.php ENDPATH**/ ?>