                ...
                <div class="container">
                  <div class="card">
                    ...
                    <p>
                      ...
                      <div class="row mb-3">                   
                      <div class="col-sm">
                        <img src="<?php echo e(asset('index_gall/commu01.jpg')); ?>" class="img-fluid" alt="">
                      </div>  
                      <div class="col-sm">
                        <img src="<?php echo e(asset('index_gall/commu02.jpg')); ?>" class="img-fluid" alt="">
                      </div>   
                      <div class="col-sm">
                        <img src="<?php echo e(asset('index_gall/commu03.jpg')); ?>" class="img-fluid" alt="">
                      </div>                  
                    </div>
...
<?php echo $__env->make('index.index_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/index/community.blade.php ENDPATH**/ ?>