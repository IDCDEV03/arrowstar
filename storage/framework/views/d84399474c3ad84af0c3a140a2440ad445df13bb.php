...
<label class="col-sm-3 col-form-label pt-0">ภาพสถานที่ท่องเที่ยว</label>
                  ...
                  <div class="row"> 
                    ...
                    <?php else: ?>
                        <button class="btn btn-info btn-sm" type="button" data-bs-toggle="modal"  data-bs-target="#upload_img">เพิ่มภาพสถานที่</button>
                    <?php endif; ?>
                     </div>               
                    ...
                    <div class="col-sm">
<img src="<?php echo e(asset($row->travel_img)); ?>" class="img-fluid img-thumbnail" width="300px" alt="">
<a href="<?php echo e(route('admin.delete_travel_img', ['id' => $row->id])); ?>" onclick="return confirm('ต้องการลบ ใช่หรือไม่?');" class="btn btn-xs btn-danger">ลบ</a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
