                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <div class="mb-3">      
                                    ...
                                    <input type="text" class="form-control input-air-primary  form-control-sm" name="program_day" id="program_day" value="<?php echo e($day_program); ?>" readonly>                                    
                                  </div>
                                </div>  
                              </div>
                              ...
                              <div class="row">
                                <div class="col-md-8">
                                  <div class="mb-3">      
                                    ...
                                    <textarea class="form-control input-air-primary form-control-sm" id="program_detail" name="program_detail"  rows="3"></textarea>                              
                                  </div>
                                </div>  
                              </div>
                                ...
                                <table class="table table-hover display" id="basic-1">
                                    <thead>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <th scope="row">
                                            <input type="hidden" name="province_id" value="<?php echo e($item->country_id); ?>">
