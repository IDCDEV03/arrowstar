                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                  ...
                                  <div class="mb-2">
                                    ...
                                    <textarea class="form-control" id="tips_box" name="program_tips" rows="3"><?php echo e($row->program_tips); ?></textarea>
                                  </div>

                                  <div class="mb-2">
                                    <label for="f1-last-name"><span class="txt-info" style="font-weight: bold">ราคารวม</span></label>
                                    <textarea class="form-control" name="price_total" rows="3"><?php echo e($row->price_total); ?></textarea>
                                  </div>

                                  <div class="mb-2">
                                    <label for="f1-last-name"><span class="txt-danger" style="font-weight: bold"> ราคาไม่รวม</span></label>
                                    <textarea class="form-control" name="price_notin" rows="3"><?php echo e($row->price_notin); ?></textarea>
                                  </div>
