        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?php echo e(asset('plugin_index/img/bg_ar03.jpg')); ?>" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">ArrowStar</h4>
                            <h1 class="display-3 text-white mb-md-4">Let's Discover The World Together</h1>
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary py-md-3 px-md-5 mt-2">ฝากข้อมูลติดต่อ</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="<?php echo e(asset('plugin_index/img/beach1.jpg')); ?>" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="<?php echo e(asset( 'plugin_index/img/ArrowStar.png')); ?>" style="object-fit: cover;">
                    </div>
                </div>
    ...
    <!-- Destination Start -->
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                ...
                <a href="<?php echo e(route('van_list')); ?>" class="h1">รถบัส VIP / รถตู้ VIP</a>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                    <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/5353349.jpg')); ?>" alt="">                 
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/55353350-2.jpg')); ?>" alt="">                    
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/42456_1.jpg')); ?>" alt="">                    
                    </div>
                </div>                
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                    <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/van4.png')); ?>" alt="">                 
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/van1.png')); ?>" alt="">                    
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="<?php echo e(asset('plugin_index/img/van2.png')); ?>" alt="">                    
                    </div>
                </div>                
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <ul class="list-inline text-white m-0">
                        ...
                        <li class="py-2"><img src="<?php echo e(asset('index_gall/line.png')); ?>" class="mr-3"><a href="https://line.me/ti/p/~ar5599">LineID: ar5599</a></li>
                    </ul>
                </div>
                <div class="col-lg-5">
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form action="<?php echo e(route('save_contact_index')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('index.index_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/index/home.blade.php ENDPATH**/ ?>