            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="row pb-3">
                        ...
                        <?php $__currentLoopData = $travel_os; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="<?php echo e(route('travel_page', ['id' => $data->package_id])); ?>"><?php echo e($data->package_name); ?></a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('index.index_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/index/travel.blade.php ENDPATH**/ ?>