        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="form theme-form" action="<?php echo e(route('admin.update_package_os')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="package_id" value="<?php echo e(request()->id); ?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <?php $__currentLoopData = $data_travel_os; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="city_name"
                                                    value="<?php echo e($data->name_city); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="package_name"
                                                    value="<?php echo e($data->package_name); ?>">
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GitHub\arrowstar\resources\views/admin/edit_package_os.blade.php ENDPATH**/ ?>