...
<label class="col-sm-3 col-form-label pt-0">ภาพสถานที่ท่องเที่ยว</label>
                  ...
                  <div class="row"> 
                    ...
                    <div class="col-sm">
<img src="{{asset($row->travel_img)}}" class="img-fluid img-thumbnail" width="300px" alt="">
<a href="{{ route('admin.delete_travel_img', ['id' => $row->id]) }}" onclick="return confirm('ต้องการลบ ใช่หรือไม่?');" class="btn btn-xs btn-danger">ลบ</a>
                    </div>
                    @endforeach
