            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <H4> ชื่อแพ็คเกจ : {{ $package_name }} </H4>
                    </div>
                    @php
                        $i = '1';
                        $n = '1';
                                    ...
                                    <tbody>
                                        @foreach ($new_tours as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->name_th }}/{{ $item->name_city }}</td>
                                                <td>
                                                ...
                                                <td><a href="{{ route('admin.data_travel', ['id' => $item->travel_id]) }}"
                                    ...
                                    <tbody>
                                        @foreach ($food_lists as $row)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('admin.data_travel', ['id' => $row->travel_id]) }}"
                                                        class="btn btn-sm btn-secondary" target="_blank"><i
                                                            class="fa fa-info-circle"></i></a></td>
